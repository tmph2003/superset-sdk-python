...
A simple client for running SQL queries (and more) against Superset:
    ...
    >>> from superset_cli.auth.superset import UsernamePasswordAuth
...
from superset_cli.api.operators import Equal, Operator
from superset_cli.auth.main import Auth
from superset_cli.lib import remove_root, validate_response
from superset_cli.typing import UserType
...
class SupersetClient:  # pylint: disable=too-many-public-methods
    ...
    def export_users(self) -> Iterator[UserType]:
        ...
        # ``/users/list/`` page. For a superset workspace we need custom logic to talk
        # to Manager.
